...
<FlexBox className="absolute w-full align-center justify-center flex-col top-80 mt-8 -left-8">
  # ZOD
</FlexBox>
...
<Code
  terminal
  highlights={[[4,8],[10,12],[14,16],[18,28]]}
  customSetup={{
    dependencies: {
      zod: "3.19.1",
      miragejs: "0.1.45"
...
const moviesSchema =
  z.object({ id: z.number(), name: z.string(), year: z.number() })
   .array();
